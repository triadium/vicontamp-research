    ...
    public class GameLifetimeScope : LifetimeScope
    {
        ...
        protected override async void Configure(IContainerBuilder builder)
        {
            ...
            using (Enqueue(innerBuilder =>
            {
                ...
                // что выгрузка очередной сцены влият на остальные кубики. И наоборот, если здесь и в AdditiveSceneLoader раскомментировать,
                // то каждое дополнение сцены будет независимо обрабатывать события, так как шина станет локальной по отношению к дополнению сцены.
